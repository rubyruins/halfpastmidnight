...
class SearchIndexer extends Component {
	...
	render() {
		...
		<div class="input-group search-container">
			...
			<input type="text" value={this.state.query} onChange={this.search} className="form-control search-bar" placeholder="Find something!" aria-label="Username" aria-describedby="basic-addon1"/>
		</div>
